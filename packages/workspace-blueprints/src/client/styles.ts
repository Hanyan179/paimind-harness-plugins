...
[data-paimind-product-surface='workspace-blueprints']{position:absolute;inset:0;z-index:80;container-type:inline-size;min-width:0;min-height:0;overflow:hidden;color:var(--dsw-alias-label-primary,#17223a);background:var(--dsw-alias-bg-layer-1,#f6f8fb);font:inherit}
...
[data-paimind-workspace-blueprints-eyebrow]{margin:0;color:var(--wb-accent);font-size:12px;line-height:16px;font-weight:700;letter-spacing:.09em;text-transform:uppercase}
...
[data-paimind-workspace-blueprints-categories]{display:flex;align-items:center;justify-content:flex-start;gap:7px;min-width:0;overflow-x:auto;padding:2px}
...
[data-paimind-workspace-blueprints-results]{padding:0 30px 9px;color:var(--wb-faint);font-size:12px;line-height:16px}
...
[data-paimind-workspace-blueprints-card-meta],[data-paimind-workspace-blueprints-tags]{display:flex;flex-wrap:wrap;gap:5px;color:var(--wb-faint);font-size:12px;line-height:16px}
...
[data-paimind-workspace-blueprints-section-head]>span{color:var(--wb-faint);font-size:12px}
[data-paimind-workspace-blueprints-link]{padding:0;border:0;color:var(--wb-accent);background:transparent;font:inherit;font-size:12px;cursor:pointer}
...
[data-paimind-workspace-blueprints-tree] code{overflow:hidden;font:inherit;font-size:12px;text-overflow:ellipsis;white-space:nowrap}
...
[data-paimind-workspace-blueprints-source-head]{display:flex;justify-content:space-between;gap:10px;padding:10px 12px;border-bottom:1px solid var(--wb-line);color:var(--wb-faint);font-size:12px}
...
[data-paimind-workspace-blueprints-binding] small{overflow-wrap:anywhere;color:var(--wb-muted);font-size:12px;line-height:16px}
[data-paimind-workspace-blueprints-note]{display:flex;gap:8px;align-items:flex-start;margin:0;padding:10px 11px;border-radius:10px;color:var(--wb-muted);background:color-mix(in srgb,var(--wb-accent) 7%,var(--wb-surface));font-size:12px;line-height:17px}
[data-paimind-workspace-blueprints-note] svg{flex:none;margin-top:1px;color:var(--wb-accent)}
[data-paimind-workspace-blueprints-compact-composition]{display:flex;align-items:center;gap:7px;margin:0;padding:9px 11px;border:1px solid var(--wb-line);border-radius:9px;color:var(--wb-muted);background:color-mix(in srgb,var(--wb-surface) 94%,transparent);font-size:12px;line-height:17px}
...
[data-paimind-workspace-blueprints-copy-hint]{margin:0;color:var(--wb-faint);font-size:12px;line-height:16px;text-align:right}
[data-paimind-workspace-blueprints-feedback]{margin:0;color:var(--wb-muted);font-size:12px;line-height:17px}
...
[data-paimind-workspace-blueprints-publish]{display:grid;grid-template-rows:auto auto auto;align-content:start;gap:18px;min-height:0;flex:1;padding:22px 30px 28px;overflow:auto}
...
[data-paimind-workspace-blueprints-publish-grid]{display:grid;grid-template-columns:minmax(0,1fr);gap:12px;min-height:auto}
...
[data-paimind-workspace-blueprints-form] label,[data-paimind-workspace-blueprints-composer]>label,[data-paimind-workspace-blueprints-composition-editor]>label{display:grid;gap:6px;color:var(--wb-ink);font-size:12px;font-weight:700}
...
[data-paimind-workspace-blueprints-source-choice]>label{display:grid;gap:6px;color:var(--wb-ink);font-size:12px;font-weight:700}
[data-paimind-workspace-blueprints-source-choice]>span{align-self:center;padding-top:18px;color:var(--wb-faint);font-size:12px}
[data-paimind-workspace-blueprints-advanced]{border-top:1px solid var(--wb-line);padding-top:10px}
[data-paimind-workspace-blueprints-advanced] summary{width:max-content;color:var(--wb-muted);font-size:12px;cursor:pointer}
...
[data-paimind-workspace-blueprints-composer]>div>p{margin:4px 0 0;color:var(--wb-muted);font-size:12px;line-height:17px}
...
[data-paimind-workspace-blueprints-composer] legend,[data-paimind-workspace-blueprints-composition-editor] legend{padding:0 4px;color:var(--wb-ink);font-size:12px;font-weight:700}
...
[data-paimind-workspace-blueprints-choice] strong{font-size:12px}
[data-paimind-workspace-blueprints-choice] small{overflow-wrap:anywhere;color:var(--wb-muted);font-size:12px;line-height:15px}
...
[data-paimind-workspace-blueprints-choice-search] input{width:100%;height:34px;padding:0 10px 0 32px;border:1px solid var(--wb-line);border-radius:8px;color:var(--wb-ink);background:var(--wb-surface);font:inherit;font-size:12px}
[data-paimind-workspace-blueprints-choice-state]{display:flex;align-items:flex-start;justify-content:space-between;gap:10px;margin:0;padding:8px 10px;border-radius:8px;color:var(--wb-muted);background:color-mix(in srgb,var(--wb-accent) 6%,var(--wb-surface));font-size:12px;line-height:16px}
...
@container(max-width:1050px){[data-paimind-workspace-blueprints-layout]{grid-template-columns:minmax(250px,34%) minmax(0,1fr)}[data-paimind-workspace-blueprints-editor]{grid-template-columns:1fr;min-height:0}[data-paimind-workspace-blueprints-tree]{max-height:220px;border-right:0;border-bottom:1px solid var(--wb-line)}[data-paimind-workspace-blueprints-source]{min-height:340px}}
@media(max-width:820px){[data-paimind-workspace-blueprints]{overflow:auto}[data-paimind-workspace-blueprints]>*{flex-shrink:0}[data-paimind-workspace-blueprints-header]{position:relative;grid-template-columns:1fr;gap:12px}[data-paimind-workspace-blueprints-close]{position:absolute;top:18px;right:18px}[data-paimind-workspace-blueprints-layout]{display:flex;flex-direction:column;flex:none}[data-paimind-workspace-blueprints-catalog]{overflow:visible}[data-paimind-workspace-blueprints-detail]{overflow:visible}[data-paimind-workspace-blueprints-publish]{display:flex;flex-direction:column;flex:none;overflow:visible}[data-paimind-workspace-blueprints-publish-grid]{min-height:auto}[data-paimind-workspace-blueprints-publish-head]{flex-direction:column}[data-paimind-workspace-blueprints-publish-head]>button{white-space:nowrap}[data-paimind-workspace-blueprints-header]{padding:18px 62px 15px 18px}[data-paimind-workspace-blueprints-head-actions]{align-items:flex-start;flex-direction:row}[data-paimind-workspace-blueprints-scopes]{padding:0 18px}[data-paimind-workspace-blueprints-toolbar]{grid-template-columns:1fr;padding:13px 18px}[data-paimind-workspace-blueprints-categories]{justify-content:flex-start}[data-paimind-workspace-blueprints-results]{padding:0 18px 8px}[data-paimind-workspace-blueprints-layout]{grid-template-columns:1fr;padding:0 18px 18px}[data-paimind-workspace-blueprints-catalog]{max-height:none}[data-paimind-workspace-blueprints-detail]{min-height:0}[data-paimind-workspace-blueprints-publish]{padding:18px}[data-paimind-workspace-blueprints-publish-grid]{grid-template-columns:1fr}[data-paimind-workspace-blueprints-field-row],[data-paimind-workspace-blueprints-source-choice]{grid-template-columns:1fr}[data-paimind-workspace-blueprints-source-choice]>span{display:none}[data-paimind-workspace-blueprints-new-entry]{grid-template-columns:1fr}[data-paimind-workspace-blueprints-publish-actions]{grid-template-columns:1fr}[data-paimind-workspace-blueprints-composer-summary]{align-items:flex-start;flex-direction:column}}
@container(max-width:820px){[data-paimind-workspace-blueprints]{overflow:auto}[data-paimind-workspace-blueprints]>*{flex-shrink:0}[data-paimind-workspace-blueprints-header]{position:relative;grid-template-columns:1fr;gap:12px}[data-paimind-workspace-blueprints-close]{position:absolute;top:18px;right:18px}[data-paimind-workspace-blueprints-layout]{display:flex;flex-direction:column;flex:none}[data-paimind-workspace-blueprints-catalog]{overflow:visible}[data-paimind-workspace-blueprints-detail]{overflow:visible}[data-paimind-workspace-blueprints-publish]{display:flex;flex-direction:column;flex:none;overflow:visible}[data-paimind-workspace-blueprints-publish-grid]{min-height:auto}[data-paimind-workspace-blueprints-publish-head]{flex-direction:column}[data-paimind-workspace-blueprints-publish-head]>button{white-space:nowrap}[data-paimind-workspace-blueprints-header]{padding:18px 62px 15px 18px}[data-paimind-workspace-blueprints-head-actions]{align-items:flex-start;flex-direction:row}[data-paimind-workspace-blueprints-scopes]{padding:0 18px}[data-paimind-workspace-blueprints-toolbar]{grid-template-columns:1fr;padding:13px 18px}[data-paimind-workspace-blueprints-categories]{justify-content:flex-start}[data-paimind-workspace-blueprints-results]{padding:0 18px 8px}[data-paimind-workspace-blueprints-layout]{grid-template-columns:1fr;padding:0 18px 18px}[data-paimind-workspace-blueprints-catalog]{max-height:none}[data-paimind-workspace-blueprints-detail]{min-height:0}[data-paimind-workspace-blueprints-publish]{padding:18px}[data-paimind-workspace-blueprints-publish-grid]{grid-template-columns:1fr}[data-paimind-workspace-blueprints-field-row],[data-paimind-workspace-blueprints-source-choice]{grid-template-columns:1fr}[data-paimind-workspace-blueprints-source-choice]>span{display:none}[data-paimind-workspace-blueprints-new-entry]{grid-template-columns:1fr}[data-paimind-workspace-blueprints-publish-actions]{grid-template-columns:1fr}[data-paimind-workspace-blueprints-composer-summary]{align-items:flex-start;flex-direction:column}}
`
