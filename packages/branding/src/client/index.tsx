...
function ParamontOfficialWordmark(): JSX.Element {
  return <svg data-paimind-paramont-wordmark aria-hidden="true" viewBox="0 218.8 628 46.7" fill="currentColor" preserveAspectRatio="xMidYMid meet">
    <g transform="translate(-6 -165.7)">
      ...
      <path d="M439.5,430.4c-11.4,0-20.2-8.3-22.1-19.3-2.7-15.2,7.5-25.9,22-25.9h11.2c11.8,0,20.4,7.4,22.3,18.4,2.7,14.9-7.6,26.8-22.2,26.8Zm11.2-9.7c8.4,0,14.1-6.5,12.6-15.1a12.5,12.5,0,0,0-12.6-10.7H439.5c-8.3,0-14.1,6.5-12.6,15a12.6,12.6,0,0,0,12.6,10.8Z" />
