...
Optional type-only peers: `@paimind/agent-builder` and `@paimind/mcp-center`. Their public remote services are discovered when the panel opens and every five seconds while open; absence or errors are isolated per provider. No private repository paths or provider-specific logic are used.
...
Current name resolution, configured-versus-used resource display, native Skill loading and browser upload/binding evidence: [2026-09-07 acceptance](../../docs/acceptance/task-summary-skill-upload-2026-09-07.md).
