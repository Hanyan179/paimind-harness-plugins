import type { AgentProfileSnapshot } from '@paimind/agent-builder'
import type { HarnessAgentPresetConnection, HarnessRemoteResult } from '@paimind/harness-compat'
import type { McpConnectionSummary, McpSummaryReader } from '@paimind/mcp-center/contract'
