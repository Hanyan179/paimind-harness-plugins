...
| `./example-plugin` | `./lib/types/example-plugin.d.ts`, `./lib/example-plugin.js` | Public package export. |
...
The manifest allowlist is `lib/**/*.js`, `lib/**/*.js.map`, `lib/**/*.d.ts`, `lib/**/*.d.ts.map`, `example/**`. Generated build metadata, source tests, local Harness homes, coverage and credentials are excluded.

## Verification

- `pnpm exec tsc -b packages/scheduler-adapter-feishu-bot/tsconfig.json --pretty false`
- `pnpm exec vitest run packages/scheduler-adapter-feishu-bot/tests`
