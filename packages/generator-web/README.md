...
Native Harness Tool provider for explicit PAIMind HTML artifact generation.
...
- `pnpm exec tsc -b packages/generator-web/tsconfig.json --pretty false`
- `pnpm exec vitest run packages/generator-web/tests`
