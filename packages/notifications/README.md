...
- Internal runtime dependencies: `@paimind/artifacts` (`workspace:^`), `@paimind/better-sidebar-adapter` (`workspace:^`), `@paimind/contracts` (`workspace:^`), `@paimind/harness-compat` (`workspace:^`).
