...
| Runtime helper | `./lib/cli.js` | Package-relative generator command invoked by the root provider; not a public subpath. |
...
- `pnpm exec tsc -b packages/generator-office/tsconfig.json --pretty false`
- `pnpm exec vitest run packages/generator-office/tests`
