...
import { PaimindExtensionIcon, PaimindSearchIcon } from '@hansen/harness-compat/client-icons'
import type { McpConnectionView, McpManagement } from '@hansen/mcp-center/contract'
