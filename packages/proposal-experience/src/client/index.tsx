...
import ASSORTMENT_STORYBOARD from '../../assets/paramont-assortment-studio-storyboard.webp'
import CATEGORY_STORYBOARD from '../../assets/paramont-category-intelligence-storyboard.webp'
...
[data-paimind-proposal-avatar]{display:grid;place-items:center;flex:0 0 40px;width:40px;height:40px;border-radius:13px;background:#174a76;color:#fff;font-size:13px;font-weight:780;letter-spacing:.04em;box-shadow:0 9px 22px rgba(22,55,89,.2)}
...
[data-paimind-proposal-options][data-stage='time-horizon'] [data-paimind-proposal-option]{min-height:124px;align-items:flex-start;flex-direction:column;justify-content:space-between}
[data-paimind-proposal-options][data-stage='confirm'] [data-paimind-proposal-option]{min-height:108px}
...
[data-paimind-storyboard-frame]{position:relative;display:flex;align-items:center;justify-content:center;min-height:0;margin-top:16px;padding:12px;border:1px solid rgba(29,51,78,.13);border-radius:18px;background:#081b30;box-shadow:0 18px 38px rgba(12,31,55,.18);overflow:hidden}
[data-paimind-storyboard]{display:block;width:auto;max-width:100%;height:clamp(330px,40vh,470px);object-fit:contain}
...
@media(max-width:900px){[data-paimind-proposal-body][data-preview='true']{grid-template-columns:1fr}[data-paimind-deck-preview]{border-top:1px solid var(--dsw-alias-border-l1,rgba(110,120,135,.16));border-left:0}[data-paimind-storyboard]{height:min(430px,58vh)}}
...
const DECK_PREVIEWS: Readonly<Record<string, DeckPreviewSpec>> = Object.freeze({
  'Executive Proposal': Object.freeze({
    ...
    image: EXECUTIVE_STORYBOARD,
    imageAlt: 'Executive proposal storyboard in navy, ivory and gold',
  }),
  'Category Growth Strategy': Object.freeze({
    ...
    image: CATEGORY_STORYBOARD,
    imageAlt: 'Category intelligence storyboard with market, white-space and roadmap slides',
  }),
  'Line Review & Assortment': Object.freeze({
    ...
    image: ASSORTMENT_STORYBOARD,
    imageAlt: 'Assortment review storyboard with line, gap and recommendation slides',
  }),
})
