...
6. Load `bento-ppt`, then call the Bento Tools using this Outline Artifact and its validated Outline value. Never summarize or truncate the Outline before rendering.
