...
[data-paimind-skill-menu-hint]{margin:4px 10px 8px;color:var(--skill-muted);font-size:12px;line-height:1.6}
[data-paimind-system-row] [data-paimind-skill-description]{white-space:normal;line-height:1.6}
[data-paimind-system-control]{min-height:44px;padding:4px 0;cursor:pointer}
...
[data-paimind-skill-eyebrow]{display:flex;align-items:center;gap:8px;margin:0 0 7px;color:var(--skill-navy);font-size:12px;font-weight:760;letter-spacing:.13em;text-transform:uppercase}
...
[data-paimind-skill-add-menu] strong{font-size:12px;line-height:16px}
[data-paimind-skill-add-menu] small{color:var(--skill-muted);font-size:12px;line-height:14px}
...
[data-paimind-skill-notice]{min-height:40px;padding:9px 12px;display:flex;align-items:center;gap:8px;border:1px solid var(--skill-line);border-radius:11px;color:var(--skill-muted);background:var(--skill-surface);font-size:12px}
...
[data-paimind-skill-inline-action]{padding:3px 5px;border:0;color:inherit;background:transparent;font:inherit;font-size:12px;font-weight:700;text-decoration:underline;text-underline-offset:3px;cursor:pointer;white-space:nowrap}
...
[data-paimind-skill-primary-tabs] button span{min-width:18px;padding:1px 5px;border-radius:999px;color:var(--skill-muted);background:var(--skill-soft);font-size:12px;line-height:14px;text-align:center}
...
[data-paimind-skill-scope-title]{margin:0 0 9px;color:var(--skill-muted);font-size:12px;font-weight:750;letter-spacing:.14em;text-transform:uppercase}
...
[data-paimind-skill-scope-count]{min-width:22px;margin-left:auto;padding:1px 6px;border-radius:999px;background:color-mix(in srgb,currentColor 10%,transparent);font-size:12px;text-align:center}
...
[data-paimind-skill-select-filter]{min-height:36px;padding:7px 30px 7px 10px;border:1px solid var(--skill-line);border-radius:9px;color:var(--skill-muted);background:var(--skill-surface);font:inherit;font-size:12px}
...
[data-paimind-skill-list-summary]{margin:0;padding:10px 14px;border-bottom:1px solid var(--skill-line);color:var(--skill-muted);font-size:12px;line-height:18px}
[data-paimind-skill-result-count]{color:var(--skill-muted);font-size:12px;white-space:nowrap}
...
[data-paimind-system-control]{display:flex;align-items:center;gap:8px;color:var(--skill-muted);font-size:12px;white-space:nowrap}
[data-paimind-system-control] input[type='checkbox'][role='switch'],[data-paimind-skill-usage-row] input[type='checkbox'][role='switch']{position:relative;width:32px;height:18px;flex:0 0 auto;margin:0;appearance:none;border:1px solid var(--skill-line);border-radius:999px;background:var(--skill-soft);cursor:pointer;transition:background var(--paimind-motion-fast) ease,border-color var(--paimind-motion-fast) ease}
[data-paimind-system-control] input[type='checkbox'][role='switch']::after,[data-paimind-skill-usage-row] input[type='checkbox'][role='switch']::after{content:'';position:absolute;top:2px;left:2px;width:12px;height:12px;border-radius:50%;background:var(--skill-surface);box-shadow:0 1px 4px rgba(23,34,58,.24);transition:transform var(--paimind-motion-fast) ease}
...
[data-paimind-skill-description]{display:-webkit-box;margin-top:1px;overflow:hidden;color:var(--skill-muted);font-size:12px;line-height:16px;-webkit-line-clamp:1;-webkit-box-orient:vertical}
[data-paimind-skill-row-badges]{display:flex;align-items:center;justify-content:flex-end;gap:5px;flex-wrap:wrap}
[data-paimind-skill-category]{display:inline-flex;align-items:center;padding:3px 7px;border-radius:999px;color:var(--skill-navy);background:color-mix(in srgb,var(--skill-navy) 7%,var(--skill-surface));font-size:12px;line-height:14px;white-space:nowrap}
[data-paimind-skill-policy]{display:inline-flex;align-items:center;gap:5px;padding:3px 7px;border-radius:999px;color:var(--skill-accent);background:color-mix(in srgb,currentColor 9%,var(--skill-surface));font-size:12px;line-height:14px;white-space:normal}
...
[data-paimind-skill-usage-head] strong,[data-paimind-skill-usage-row] strong{color:var(--skill-ink);font-size:12px;line-height:17px}
[data-paimind-skill-usage-head] small,[data-paimind-skill-usage-row] small{color:var(--skill-muted);font-size:12px;line-height:15px}
...
[data-paimind-skill-usage-row] [data-paimind-skill-button]{min-height:31px;padding:5px 9px;font-size:12px}
[data-paimind-skill-contract-note]{margin:0!important;padding:10px 12px;display:flex;align-items:flex-start;gap:7px;color:var(--dsw-alias-state-warning-primary,#a66b1a)!important;background:color-mix(in srgb,currentColor 5%,var(--skill-surface));font-size:12px!important;line-height:15px!important}
...
[data-paimind-skill-disclosure] summary{padding:11px 0;color:var(--skill-muted);font-size:12px;font-weight:700;cursor:pointer}
...
[data-paimind-skill-meta-row]{display:grid;grid-template-columns:66px minmax(0,1fr);gap:9px;font-size:12px;line-height:16px}
...
[data-paimind-skill-contract-state] small{max-width:560px;color:var(--skill-muted);font-size:12px;line-height:17px}
[data-paimind-skill-loading-dot]{width:8px;height:8px;border-radius:50%;background:var(--skill-accent);animation:paimind-skill-pulse var(--paimind-motion-loop) ease-in-out var(--paimind-motion-iterations) alternate}
...
[data-paimind-skill-editor-form] small{color:var(--skill-muted);font-size:12px;font-weight:400;line-height:16px}
...
[data-paimind-skill-package-tree-head] strong{font-size:12px}[data-paimind-skill-package-tree-head] small{color:var(--skill-muted);font-size:12px;line-height:15px}
[data-paimind-skill-package-create]{display:grid;gap:9px;padding:10px;border-bottom:1px solid var(--skill-line)}
[data-paimind-skill-package-create] label{display:grid;gap:4px;color:var(--skill-muted);font-size:12px;font-weight:700}
[data-paimind-skill-package-create] label>span:last-child{display:grid;grid-template-columns:minmax(0,1fr) auto;gap:7px}
[data-paimind-skill-package-create] input{min-width:0;padding:9px 10px;border:1px solid var(--skill-line);border-radius:9px;background:var(--skill-soft);color:var(--skill-ink);font:inherit;font-size:12px;outline:none}
...
[data-paimind-skill-package-folder],[data-paimind-skill-package-file],[data-paimind-skill-package-more]{width:100%;min-height:31px;display:flex;align-items:center;gap:6px;padding:5px 8px 5px calc(8px + var(--skill-tree-depth,0) * 15px);border:0;border-radius:7px;background:transparent;color:var(--skill-ink);font:inherit;font-size:12px;text-align:left;cursor:pointer}
...
[data-paimind-skill-package-path]>div{min-width:0;display:grid;gap:3px}[data-paimind-skill-package-path] strong{overflow:hidden;text-overflow:ellipsis;white-space:nowrap;font-family:ui-monospace,SFMono-Regular,Menlo,monospace;font-size:12px}[data-paimind-skill-package-path] small{color:var(--skill-muted);font-size:12px}
...
[data-paimind-skill-package-empty]{display:grid;place-content:center;gap:8px;padding:28px;color:var(--skill-muted);text-align:center}[data-paimind-skill-package-empty] strong{color:var(--skill-ink);font-size:13px}[data-paimind-skill-package-empty] p{max-width:520px;margin:0;font-size:12px;line-height:18px}
...
@media(min-width:761px){
  [data-paimind-skill-catalog]{container-type:inline-size}
  @container(max-width:680px){
    [data-paimind-skill-grid]{grid-template-columns:1fr;min-height:0}
    [data-paimind-skill-list]{min-height:0;max-height:260px}
    [data-paimind-skill-detail]{border-left:0;border-top:1px solid var(--skill-line)}
  }
}
