...
[data-paimind-product-surface]{--skill-ink:var(--paimind-ink,var(--dsw-alias-label-primary,#17223a));--skill-muted:var(--paimind-muted,var(--dsw-alias-label-secondary,#65718a));--skill-line:var(--paimind-line,var(--dsw-alias-border-l1,rgba(110,128,154,.16)));--skill-accent:var(--paimind-accent,var(--dsw-alias-state-business-primary,#3471f5));--skill-navy:var(--paimind-navy,#18324d);--skill-canvas:var(--paimind-canvas,var(--dsw-alias-bg-base,#f4f7fb));--skill-surface:var(--paimind-glass-strong,var(--dsw-alias-bg-layer-1,#fff));--skill-soft:var(--paimind-glass,var(--dsw-alias-bg-layer-2,rgba(128,128,128,.055)));--skill-shadow:var(--paimind-shadow,0 14px 40px rgba(39,63,102,.08));--skill-radius:var(--paimind-radius,18px);position:fixed;inset:0;z-index:80;display:grid;grid-template-rows:64px minmax(0,1fr);pointer-events:auto;color:var(--skill-ink);background:var(--skill-canvas);font:inherit}
[data-paimind-product-surface] *{box-sizing:border-box}
[data-paimind-product-initial-focus]:focus{outline:none}
[data-paimind-product-bar]{display:flex;align-items:center;gap:18px;min-width:0;padding:0 24px;border-bottom:1px solid var(--skill-line);background:var(--skill-surface)}
...
[data-paimind-product-brand-icon]{width:34px;height:34px;display:grid;place-items:center;border-radius:10px;color:#fff;background:var(--skill-navy)}
[data-paimind-product-switcher]{display:flex;align-items:center;gap:4px;margin-left:18px;padding:4px;border-radius:11px;background:var(--skill-soft)}
[data-paimind-product-switch]{min-height:34px;padding:6px 12px;display:inline-flex;align-items:center;gap:7px;border:0;border-radius:8px;color:var(--skill-muted);background:transparent;font:inherit;font-size:12px;cursor:pointer}
[data-paimind-product-switch][aria-current='page']{color:var(--skill-accent);background:var(--skill-surface);box-shadow:0 1px 3px rgba(31,49,79,.08)}
...
[data-paimind-product-return],[data-paimind-product-close]{display:inline-flex;align-items:center;justify-content:center;gap:7px;border:1px solid var(--skill-line);color:var(--skill-muted);background:var(--skill-surface);font:inherit;cursor:pointer}
[data-paimind-product-return]{min-height:36px;padding:7px 12px;border-radius:9px;font-size:12px}
[data-paimind-product-close]{width:36px;height:36px;padding:0;border-radius:50%}
[data-paimind-product-return]:hover,[data-paimind-product-close]:hover{color:var(--skill-ink);background:var(--skill-soft)}
[data-paimind-product-body]{min-height:0;overflow:auto;padding:22px clamp(18px,3vw,48px) 48px;background:var(--skill-canvas)}
[data-paimind-skill-market]{width:min(1440px,100%);min-height:100%;margin:0 auto;color:inherit}
[data-paimind-skill-hero]{display:grid;grid-template-columns:minmax(0,1fr) auto;gap:24px;align-items:center;padding:22px 26px;border:1px solid var(--skill-line);border-radius:calc(var(--skill-radius) + 4px);background:var(--skill-surface);box-shadow:var(--skill-shadow)}
...
[data-paimind-skill-workspace]{display:grid;grid-template-columns:188px minmax(0,1fr);gap:16px;align-items:start;margin-top:16px}
...
[data-paimind-skill-row]{display:grid;grid-template-columns:minmax(0,1fr) auto;gap:8px;align-items:center;padding:9px;border:1px solid transparent;border-radius:12px}
...
[data-paimind-skill-favorite]{width:34px;height:34px;padding:0;display:grid;place-items:center;border:0;border-radius:9px;color:var(--skill-muted);background:transparent;cursor:pointer}
[data-paimind-skill-favorite][aria-pressed='true']{color:var(--skill-accent);background:color-mix(in srgb,currentColor 10%,transparent)}
...
[data-paimind-product-surface] :is(button,input,select,summary):focus-visible{outline:2px solid var(--skill-accent);outline-offset:2px}
...
@media(max-width:760px){[data-paimind-product-bar]{padding:0 10px;gap:7px}[data-paimind-product-brand] span:last-child,[data-paimind-product-switch] span,[data-paimind-product-return] span{display:none}[data-paimind-product-switcher]{margin-left:0}[data-paimind-product-switch]{width:36px;padding:0;justify-content:center}[data-paimind-product-return]{width:36px;padding:0}[data-paimind-product-body]{padding:10px 10px 28px}[data-paimind-skill-hero]{grid-template-columns:1fr;padding:16px;border-radius:16px;gap:14px}[data-paimind-skill-hero] h1{font-size:30px}[data-paimind-skill-intro]{font-size:12px;line-height:19px}[data-paimind-skill-head-actions]{justify-content:flex-start}[data-paimind-skill-button],[data-paimind-skill-filter],[data-paimind-skill-scope-button],[data-paimind-skill-select-filter]{min-height:44px}[data-paimind-skill-workspace]{margin-top:10px;gap:10px}[data-paimind-skill-scope]{overflow:auto}[data-paimind-skill-scope-list]{display:flex;min-width:max-content}[data-paimind-skill-scope-button]{width:auto;min-width:112px}[data-paimind-skill-toolbar]{grid-template-columns:1fr;padding:10px}[data-paimind-skill-filterbar]{align-items:flex-start;flex-direction:column;padding:9px 10px}[data-paimind-skill-filters]{width:100%}[data-paimind-skill-select-filter]{min-width:0;flex:1}[data-paimind-skill-grid]{display:block;min-height:0}[data-paimind-skill-list]{max-height:none;min-height:0}[data-paimind-skill-row]{padding:8px 4px}[data-paimind-skill-select]{grid-template-columns:38px minmax(0,1fr)}[data-paimind-skill-select]>[data-paimind-skill-policy]{display:none}[data-paimind-skill-detail]{position:fixed;inset:64px 0 0;z-index:95;display:none;padding:22px 18px 40px;border:0;overflow:auto;background:var(--skill-canvas)}[data-paimind-skill-detail][data-mobile-open='true']{display:grid}[data-paimind-skill-mobile-close]{display:grid;place-items:center}[data-paimind-skill-dialog-backdrop]{padding:10px}[data-paimind-skill-dialog]{padding:19px;border-radius:16px}[data-paimind-skill-review-grid]{grid-template-columns:1fr}[data-paimind-skill-dialog-actions]{display:grid;grid-template-columns:1fr}[data-paimind-skill-dialog-actions] [data-paimind-skill-button]{width:100%}}
@media(max-width:420px){[data-paimind-skill-scope]{scrollbar-width:none}[data-paimind-skill-scope]::-webkit-scrollbar{display:none}[data-paimind-skill-scope-button]{min-width:98px}[data-paimind-skill-filters]{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));width:100%}[data-paimind-skill-select-filter]{width:100%}[data-paimind-skill-filter]{width:100%;grid-column:1/-1}}
