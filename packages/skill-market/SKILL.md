...
- If the current Session is not bound to a PAIMind-managed Agent, finish after installation.
...
- Explain that binding changes the Agent configuration used by future conversations; it does not silently rewrite the already-running Session.
