...
Harness Session and Native Job adapter for the PAIMind platform scheduler.
...
| `./agent-action` | `./lib/types/agent-action.d.ts`, `./lib/agent-action.js` | Public package export. |
...
- `pnpm exec tsc -b packages/scheduler-adapter-harness/tsconfig.json --pretty false`
- `pnpm exec vitest run packages/scheduler-adapter-harness/tests`
