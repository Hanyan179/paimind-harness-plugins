...
export async function apply(ctx: McpClientContext): Promise<() => Promise<void>> {
  ...
  contributePaimindExtension(scope.slots, { id: 'paimind:mcp-center', packageName: '@paimind/mcp-center', nameZh: '连接中心', nameEn: 'MCP Center', descriptionZh: '管理个人工具连接，测试并绑定给助手。', descriptionEn: 'Manage, test, and bind personal tool connections.', category: 'skills-tools', surface: 'shell', maturity: 'technical-preview', order: 35 })
