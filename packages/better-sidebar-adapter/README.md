...
- Internal runtime dependencies: `@hansen/harness-compat` (`workspace:^`), `@hansen/workspace-project` (`workspace:^`).
- External runtime or peer dependencies: `dsh-better-sidebar` (`0.17.1`), `react` (`>=18.0.0 <20.0.0`).
- Client service injection: `@deepseek-ai/dsh-client-runtime`, `@deepseek-ai/dsh-client-locale`, `@hansen/workspace-project`, `dsh-better-sidebar`.
