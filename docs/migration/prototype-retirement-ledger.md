...
| `src/components/account/SettingsViews.jsx`, `src/user-settings-context.jsx` | Theme, locale, preferences and AI settings | Native Reuse plus product-owned extension; browser-local duplicate settings retired | Harness Settings + `@paimind/user-settings` |
